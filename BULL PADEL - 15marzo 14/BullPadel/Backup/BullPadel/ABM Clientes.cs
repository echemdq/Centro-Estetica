...
namespace BullPadel
{
    public partial class ABM_Clientes : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (label5.Text == "")
            {
                string cmdtext = "insert into clientes(descripcion, telefono, dni, saldo) values('" + textBox2.Text + "','" + textBox1.Text + "','" + textBox3.Text + "','" + textBox4.Text + "')";
            ...
            {
                string cmdtext = "update clientes set descripcion = '" + textBox2.Text + "', telefono = '" + textBox1.Text + "', dni = '" + textBox3.Text + "', saldo = '" + textBox4.Text + "' where idclientes = '" + label5.Text + "'";
                oacceso.ActualizarBD(cmdtext);
                this.Close();
                MessageBox.Show("Cliente guardado exitosamente");
            }
