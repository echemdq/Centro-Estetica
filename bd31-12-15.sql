...
INSERT INTO `horariosprofesionales` VALUES (1,2,'09:00','11:00','2015-12-01 00:00:00','2016-01-06 00:00:00','1','1','1','1','1','1','0','0'),(3,3,'15:00','20:00','2015-12-18 00:00:00','2015-12-20 00:00:00','0','0','0','0','0','1','0','0');
...
INSERT INTO `profesionales` VALUES (2,'ezequiel vazquez','123',1,'asd','213',1,'asd1'),(3,'fer','321',1,'asd','321',1,'dsa'),(4,'das','3212',1,'dwq','2134',1,'dwq'),(5,'ecc','322',1,'wda','3421',1,'weq');
...
INSERT INTO `turnos` VALUES (2,2,'09:00','2015-12-14 00:00:00','','','','0','1','',''),(3,2,'09:00','2016-01-05 00:00:00','1','probando','q','2','2','123','2');
...
jueves,viernes,sabado,domingo, case when mod(weekofyear(fec),2) = 0 then 2 else 1 end as par, ingreso, egreso
...
SET lc_time_names = 'es_MX';
		select p.idprofesionales, p.profesional,
			ifnull((select fn_protrabaja(p.idprofesionales,fec)),'') as horario , f.detalle as feriado
...
-- Dump completed on 2015-12-31 12:16:09
